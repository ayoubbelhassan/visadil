...
function Home() {
  return (
    ...
    <div className="bg-homebg w-full h-[105vh] bg-fixed bg-no-repeat bg-center bg-cover" style={{ 
        ...
        clipPath: 'polygon(0 0, 0 98%, 8% 97%, 15% 97%, 22% 97%, 31% 98%, 46% 99%, 62% 100%, 77% 100%, 92% 99%, 100% 97%, 100% 0)'
          ...
          <h3 className='text-center font-Cairo text-2xl md:text-3xl text-yel font-normal leading-normal'>Visadil</h3>
          

          <h1 class="text-center text-white font-cairo text-3xl md:text-6xl font-extrabold leading-tight my-10 md:my-7 mx-1">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="33" height="50" viewBox="0 0 33 50" fill="none" className='mt-10'>
            <rect x="0.5" y="0.5" width="31.6389" height="49" rx="15.8194" stroke="white"/>
            <path d="M15.9722 21.1111V28.75" stroke="white" stroke-linecap="round" className='animate-bounce'/>
        </svg>
